...
public class ContactActivity extends BaseActivity {
    ...
    protected void onCreateFinished() {
        ...
        jobPresenter.getContactData(this);
    }
    ...
    class ViewHolder implements UserAuthContract.View {
        ...
        private void initRecyclerView() {
            ...
            adapter = new UserAdapter(ContactActivity.this, mData);
            ...
            rvList.setLayoutManager(new LinearLayoutManager(ContactActivity.this));
            rvList.addItemDecoration(new DividerListItemDecoration(ContactActivity.this, LinearLayoutManager.VERTICAL));
