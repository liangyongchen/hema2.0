...
public class JobActivity extends BaseActivity {
    ...
    class ViewHolder implements UserAuthContract.View {
        ...
        private void initRecyclerView() {
            ...
            adapter = new UserAdapter(JobActivity.this, mData);
            ...
            rvList.setLayoutManager(new LinearLayoutManager(JobActivity.this));
            rvList.addItemDecoration(new DividerListItemDecoration(JobActivity.this, LinearLayoutManager.VERTICAL));
