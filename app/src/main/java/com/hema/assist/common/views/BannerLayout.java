...
import com.hema.assist.common.views.bannerlayoutmanager.BannerLayoutManager;
import com.hema.assist.common.views.bannerlayoutmanager.CenterSnapHelper;
import com.wtw.p2p.R;

import static android.widget.AbsListView.OnScrollListener.SCROLL_STATE_IDLE;

/**
 * Created by 河马安卓 on 2018/4/18.
 */
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        params.gravity = Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL; // 位置摆放设置
    ...
    // 设置指示器图片
    public void setIndicatorDrawble(Drawable select, Drawable unSelect) {
        this.mSelectedDrawable = select;
        this.mUnselectedDrawable = unSelect;
    }
